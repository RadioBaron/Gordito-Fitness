...
self.addEventListener('fetch', e => {
  ...
  // For API requests (wger, freedb) – network only, no caching
  if (e.request.url.includes('wger.de') || e.request.url.includes('githubusercontent.com')) {
    return;
  }
